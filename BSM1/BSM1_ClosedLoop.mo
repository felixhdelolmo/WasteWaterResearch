...
model BSM1_ClosedLoop
  ...
  Modelica.Blocks.Sources.Step step1(startTime = 130, offset = -1, height = 1) annotation(Placement(visible = true, transformation(origin = {-105.338,77.5801}, extent = {{-12,-12},{12,12}}, rotation = 0)));
  ...
  Modelica.Blocks.Nonlinear.FixedDelay fixeddelay1(delayTime = 1 / 6 / 24) annotation(Placement(visible = true, transformation(origin = {10.3203,67.97150000000001}, extent = {{-6.77369,-6.77369},{6.77369,6.77369}}, rotation = 0)));
  Modelica.Blocks.Nonlinear.Limiter limiter1(uMax = 10, uMin = 0.1) annotation(Placement(visible = true, transformation(origin = {32.7402,68.3274}, extent = {{-6.77369,-6.77369},{6.77369,6.77369}}, rotation = 0)));
  ...
  Modelica.Blocks.Sources.Step OxygenSetpoint(startTime = 0, height = 2) annotation(Placement(visible = true, transformation(origin = {21.7082,45.1958}, extent = {{-8.196160000000001,-8.196160000000001},{8.196160000000001,8.196160000000001}}, rotation = 0)));
  ...
  WasteWater.ASM1.sensor_NO sensor_no1 annotation(Placement(visible = true, transformation(origin = {-8.540929999999999,48.3986}, extent = {{-8.196160000000001,-8.196160000000001},{8.196160000000001,8.196160000000001}}, rotation = 0)));
  WasteWater.ASM1.sensor_O2 sensor_o21 annotation(Placement(visible = true, transformation(origin = {35.2313,23.1317}, extent = {{-8.196160000000001,-8.196160000000001},{8.196160000000001,8.196160000000001}}, rotation = 0)));
  ...
  WasteWater.ASM1.mixer3 mixer annotation(Placement(visible = true, transformation(origin = {-73.90300000000001,26.8318}, extent = {{-14.52,-14.52},{14.52,14.52}}, rotation = 0)));
  ...
  WasteWater.ASM1.ADsensor_Q ADsensor_Effluent annotation(Placement(visible = true, transformation(origin = {104.8,29.5691}, extent = {{-12,-12},{12,12}}, rotation = 360)));
  WasteWater.ASM1.ADsensor_Q ADsensor_Waste annotation(Placement(visible = true, transformation(origin = {55.8603,-42.6901}, extent = {{-12,12},{12,-12}}, rotation = -90)));
equation
  connect(ADsensor_Waste.Out,WasteSludge.In) annotation(Line(points = {{54.871,-53.4521},{54.871,-53.1716},{55.0621,-64.5783},{60.9901,-64.5783},{60.9901,-64.934}}));
  connect(WastePump.Out,ADsensor_Waste.In) annotation(Line(points = {{63.7051,-11.4698},{54.9398,-11.4698},{54.871,-31.3087},{54.871,-31.5892}}));
  ...
  connect(Settler.Effluent,ADsensor_Effluent.In) annotation(Line(points = {{76.20650000000001,31.2693},{93.5943,31.2693},{93.6991,30.5584},{93.6991,30.5584}}));
  ...
  connect(Temperature.y,tank3.T) annotation(Line(points = {{-95.9199,43.7284},{-89.6797,43.7284},{-89.6797,16.0143},{-66.90389999999999,16.0143},{-66.90389999999999,8.300879999999999},{-66.455,8.300879999999999}}));
  connect(Temperature.y,tank4.T) annotation(Line(points = {{-95.9199,43.7284},{-89.6797,43.7284},{-89.6797,16.0143},{-39.1459,16.0143},{-39.1459,8.540929999999999},{-38.3411,8.540929999999999},{-38.3411,8.300879999999999}}));
  connect(Temperature.y,tank5.T) annotation(Line(points = {{-95.9199,43.7284},{-90.0356,43.7284},{-90.0356,16.0142},{-10.3203,16.0142},{-10.3203,8.63353},{-9.89818,8.63353}}));
  ...
  connect(PI1.y,blower3.u) annotation(Line(points = {{77.3432,55.516},{87.9004,55.516},{87.9004,-21.7082},{9.964410000000001,-21.7082},{9.964410000000001,-18.8831},{10.5292,-18.8831}}));
  ...
  connect(sensor_o21.So,feedback2.u2) annotation(Line(points = {{43.0486,23.7874},{44.484,23.7874},{44.484,36.2989},{46.6192,36.2989},{46.6192,40.6584},{46.9751,40.6584}}));
  connect(tank5.MeasurePort,sensor_o21.In) annotation(Line(points = {{6.95965,9.65136},{6.40569,9.65136},{6.40569,14.5907},{34.8754,14.5907},{34.8754,17.3879},{34.9171,17.3879}}));
  connect(sensor_no1.Sno,fixeddelay1.u) annotation(Line(points = {{-0.763161,49.1333},{1.06762,49.1333},{1.06762,67.97150000000001},{2.19187,67.97150000000001}}));
  connect(tank2.MeasurePort,sensor_no1.In) annotation(Line(points = {{-3.03896,33.0188},{-3.55872,33.0188},{-3.55872,38.79},{-8.896800000000001,38.79},{-8.896800000000001,42.6548},{-8.815659999999999,42.6548}}));
  connect(OxygenSetpoint.y,feedback2.u1) annotation(Line(points = {{30.724,45.1958},{40.9253,45.1958},{40.9253,46.6192},{41.0143,46.6192}}));
  ...
  connect(fixeddelay1.y,limiter1.u) annotation(Line(points = {{17.7713,67.97150000000001},{24.1993,67.97150000000001},{24.1993,68.3274},{24.6118,68.3274}}));
