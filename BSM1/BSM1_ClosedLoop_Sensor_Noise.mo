within BSM1;
model BSM1_ClosedLoop_Sensor_Noise
  ...
  WasteWater.ASM1.blower blower1(Q_max = 34574.2654508612) annotation(Placement(visible = true, transformation(origin = {-54.8043,-16.3701}, extent = {{-9.015779999999999,-9.015779999999999},{9.015779999999999,9.015779999999999}}, rotation = 0)));
  ...
  Modelica.Blocks.Continuous.PI PI2(k = 0.10842, T = 0.025) annotation(Placement(visible = true, transformation(origin = {68.6833,91.1032}, extent = {{-7.45106,-7.45106},{7.45106,7.45106}}, rotation = 0)));
  ...
  Modelica.Blocks.Continuous.PI PI1(k = 0.1042, T = 0.002) annotation(Placement(visible = true, transformation(origin = {68.3274,55.516}, extent = {{-8.196160000000001,-8.196160000000001},{8.196160000000001,8.196160000000001}}, rotation = 0)));
  ...
  Modelica.Blocks.Nonlinear.Limiter limiter1(uMax = 20, uMin = 0.1) annotation(Placement(visible = true, transformation(origin = {48.7544,68.3274}, extent = {{-6.77369,-6.77369},{6.77369,6.77369}}, rotation = 0)));
  WasteWater.ASM1.Noise noise1(delta = 0.5, noise_sampling = 15 / 60 / 24) annotation(Placement(visible = true, transformation(origin = {28.1139,68.3274}, extent = {{-6.1579,-6.1579},{6.1579,6.1579}}, rotation = 0)));
  Modelica.Blocks.Sources.Step OxigenSetpoint(startTime = 0, height = 2) annotation(Placement(visible = true, transformation(origin = {12.4555,48.7545}, extent = {{-8.196160000000001,-8.196160000000001},{8.196160000000001,8.196160000000001}}, rotation = 0)));
  WasteWater.ASM1.sensor_class_A sensor_class_a1 annotation(Placement(visible = true, transformation(origin = {30.4506,35.9293}, extent = {{-5.59809,-5.59809},{5.59809,5.59809}}, rotation = 0)));
  Modelica.Blocks.Math.Feedback feedback2 annotation(Placement(visible = true, transformation(origin = {46.9751,49.4662}, extent = {{-7.45106,-7.45106},{7.45106,7.45106}}, rotation = 0)));
  WasteWater.ASM1.Noise noise2(delta = 0.25, noise_sampling = 15 / 60 / 24) annotation(Placement(visible = true, transformation(origin = {47.331,34.8754}, extent = {{-6.1579,-6.1579},{6.1579,6.1579}}, rotation = 0)));
  ...
  WasteWater.ASM1.pump WastePump(Q_max = 385) annotation(Placement(visible = true, transformation(origin = {72.2891,-9.15663}, extent = {{12,12},{-12,-12}}, rotation = 0)));
...
equation
  connect(ADsensor_Waste.Out,WasteSludge.In) annotation(Line(points = {{54.871,-52.8911},{54.871,-53.1716},{55.0621,-64.5783},{60.9901,-64.5783},{60.9901,-64.934}}));
  connect(WastePump.Out,ADsensor_Waste.In) annotation(Line(points = {{63.7051,-11.4698},{54.9398,-11.4698},{54.871,-31.3087},{54.871,-31.0282}}));
  connect(constant1.y,WastePump.u) annotation(Line(points = {{24.4322,-72.5979},{34.2169,-72.5979},{34.2169,-89.1566},{93.494,-89.1566},{93.494,-31.8072},{82.53060000000001,-11.6782},{82.53060000000001,-11.6782}}));
  connect(Settler.Waste,WastePump.In) annotation(Line(points = {{71.8933,16.6216},{80.4819,16.6216},{80.6142,-7.45555},{80.6142,-7.45555}}));
  ...
  connect(Temperature.y,tank3.T) annotation(Line(points = {{-95.9199,43.7284},{-89.6797,43.7284},{-89.6797,16.726},{-66.90389999999999,16.726},{-66.90389999999999,8.300879999999999},{-66.455,8.300879999999999}}));
  connect(Temperature.y,tank4.T) annotation(Line(points = {{-95.9199,43.7284},{-89.6797,43.7284},{-89.6797,16.726},{-39.1459,16.726},{-39.1459,8.540929999999999},{-38.3411,8.540929999999999},{-38.3411,8.300879999999999}}));
  connect(Temperature.y,tank5.T) annotation(Line(points = {{-95.9199,43.7284},{-90.0356,43.7284},{-90.0356,16.726},{-10.3203,16.726},{-10.3203,8.63353},{-9.89818,8.63353}}));
  connect(noise2.y,feedback2.u2) annotation(Line(points = {{54.1046,34.8754},{55.1601,34.8754},{55.1601,43.0605},{46.9751,43.0605},{46.9751,43.5053}}));
  connect(sensor_class_a1.y,noise2.u) annotation(Line(points = {{36.6085,35.9293},{39.5018,35.9293},{39.5018,34.8754},{39.9415,34.8754}}));
  connect(OxigenSetpoint.y,feedback2.u1) annotation(Line(points = {{21.4713,48.7545},{40.9253,48.7545},{40.9253,49.4662},{41.0143,49.4662}}));
  connect(feedback2.y,PI1.u) annotation(Line(points = {{53.6811,49.4662},{56.9395,49.4662},{56.9395,55.1601},{58.492,55.1601},{58.492,55.516}}));
  connect(sensor_class_a1.u,sensor_O2.So) annotation(Line(points = {{23.7329,35.9293},{22.2132,35.9293},{22.2132,23.3055},{25.6992,23.3055}}));
  connect(sensor_class_b1.y,noise1.u) annotation(Line(points = {{15.4251,68.4337},{21.3523,68.4337},{21.3523,68.3274},{20.7244,68.3274}}));
  connect(noise1.y,limiter1.u) annotation(Line(points = {{34.8876,68.3274},{39.5018,68.3274},{39.5018,68.3274},{40.626,68.3274}}));
  connect(limiter1.y,feedback1.u2) annotation(Line(points = {{56.2055,68.3274},{59.0747,68.3274},{59.0747,83.9858},{45.5516,83.9858},{45.5516,84.1904}}));
...
end BSM1_ClosedLoop_Sensor_Noise;
