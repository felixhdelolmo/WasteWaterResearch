...
"));
  model preclar1 "Dynamic ASM1 Primary Clarifier Model" 
    ...
    Real XCODin;
    Real H;
    ASM1.Interfaces.WWFlowAsm1in In annotation (extent=[-110, -10; -90, 10]);
    ASM1.Interfaces.WWFlowAsm1out Out annotation (extent=[90, -10; 110, 10]);
    ASM1.Interfaces.WWFlowAsm1out MeasurePort annotation (extent=[32, 90; 42, 
          100]);
    annotation (
      Coordsys(
...
"));
  ...
  model preclar3 "Inverse ASM1 Static Primary Clarifier Model" 
    ...
    ASM1.Interfaces.WWFlowAsm1in In annotation (extent=[-110, -10; -90, 10]);
    ASM1.Interfaces.WWFlowAsm1out Out annotation (extent=[90, -10; 110, 10]);
    Modelica.Blocks.Interfaces.InPort MeasurePort(final n=4) annotation (extent
        =[28, 80; 48, 100], rotation=-90);
    annotation (
      Coordsys(
        extent=[-100, -100; 100, 100], 
        grid=[2, 2], 
